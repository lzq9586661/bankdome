      ...
      >
        ...
        <el-table-column label="操作" width="220px">
          <template slot-scope="scope">
            ...
            <el-button v-if="scope.row.cs === true" type="primary" plain @click="handleSp(scope.row)">重新审批</el-button>
          </template>
        </el-table-column>
      </el-table>
      <pagination v-show="total > 0" :total="total" :page.sync="listQuery.pageNo" :limit.sync="listQuery.pageSize" @pagination="getList" />

      <el-dialog title="年费人工单笔审批单" :visible.sync="softsFlag" width="50%" :close-on-click-modal="false" top="10vh">
        <el-collapse v-model="activeNames" @change="handleChange">
          ...
          <el-collapse-item v-if="spFlag === false" title="审批信息" name="3">
            <el-form ref="softForm" label-width="120px" :model="softObj">
              <el-form-item label="审批状态" prop="kh">
                <el-input v-model="softObj.kh" clearable :readonly="showFlag" />
              </el-form-item>
              <el-form-item label="拒绝原因" prop="kh">
                <el-input v-model="softObj.kh" clearable type="textarea" :readonly="showFlag" />
              </el-form-item>
            </el-form>
          </el-collapse-item>
          <el-collapse-item v-if="spFlag === false" title="列表信息" name="2">
            <el-table
              v-loading="listLoading"
              :data="tList1"
              element-loading-text="拼命加载中"
