    ...
    <div class="panel-style">
      <el-form :inline="true" label-width="120px" @submit.native.prevent>
        ...
        <el-form-item label="申请任务名称">
          <el-input v-model="listQuery.kh" placeholder="请输入申请任务名称" clearable />
        </el-form-item>
      ...
      >
        ...
        <el-table-column label="批量工单名称" prop="nfsqsj"></el-table-column>
        <el-table-column label="工单笔数" prop="bz"></el-table-column>
        <el-table-column label="调减总额" prop="tjzc"></el-table-column>
        <el-table-column label="工单时间" prop="tzfx"></el-table-column>
        <el-table-column label="反馈时间" prop="tjje"></el-table-column>
      ...
      <el-dialog title="息费批量反馈" :visible.sync="softsFlag" width="80%" :close-on-click-modal="false" top="10vh">
        <el-collapse v-model="activeNames" @change="handleChange">
          ...
          <el-collapse-item title="工单明细" name="2">
            ...
            >
              <el-table-column label="序号" prop="xh"></el-table-column>
              <el-table-column label="卡号" prop="xh"></el-table-column>
              <el-table-column label="唯一标识" prop="spsj"></el-table-column>
              <el-table-column label="年费收取时间" prop="spr"></el-table-column>
          ...
          <el-collapse-item title="反馈信息" name="21">
            <el-table
              v-loading="listLoading"
              :data="tList1"
              element-loading-text="拼命加载中"
